...
namespace PeliculasAPI.Controllers
{
    ...
    {
        private readonly ApplicationDbContextPeliculas context;
        private readonly IMapper mapper;
        private readonly IAlmacenadorArchivos almacenadorArchivos;
        private readonly string contenedor = "actores";

        public ActoresController(ApplicationDbContextPeliculas context, IMapper mapper, IAlmacenadorArchivos almacenadorArchivos)
        {
        ...
        public async Task<ActionResult> Put(int id, [FromForm] ActorCreacionDTO actorCreacionDTO)
        {
            ...
            // Se toman los campos de actorcreacionDTO y se mapean hacia actorDB
            ...
            if (actorCreacionDTO.Foto != null)
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    var contenido = memoryStream.ToArray();
                    var extension = Path.GetExtension(actorCreacionDTO.Foto.FileName);
                    actorDB.Foto = await almacenadorArchivos.EditarArchivo(
